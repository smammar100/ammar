...
# Making a Complex Query Language Approachable
...
Description:
JupiterOne faced a critical user adoption challenge: new customers were thrown into free-form querying without understanding what to ask for or how to ask for it.

Impact:
Reduced new users' time to build a custom query from 21 days to 1.
