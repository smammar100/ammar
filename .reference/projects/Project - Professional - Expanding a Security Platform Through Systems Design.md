...
Skills:
Product Strategy, Systems Design, UX Architecture

Description:
Signal Sciences discovered customers 'hacking' core features for new security use cases. Instead of building separate solutions, we created a modular system that extended platform capabilities.
