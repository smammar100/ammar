...
export const roles: Role[] = [
  ...
  },
  {
    ...
    dateRange: "2024–2025",
    summary:
      "Part-time freelance bringing early-stage startup MVPs and landing pages to life for US clients, remote. Headline act: a full Truewind (YC W23) rebrand covering logo, UI system, and landing page, delivered in under two weeks.",
